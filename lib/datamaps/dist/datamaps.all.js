...
(function() {
    ...
    arcs
      .enter()
        ...
        .attr('d', function(datum) {
            ...
            var arcSharpnessJASON;
            if ( datum.options && datum.options.arcSharpness) {
            arcSharpnessJASON=datum.options.arcSharpness;
            }
            else {
              arcSharpnessJASON=options.arcSharpness;
            }

            var midXY = [ (originXY[0] + destXY[0]) / 2, (originXY[1] + destXY[1]) / 2];
            var val="M" + originXY[0] + ',' + originXY[1] + "S" + (midXY[0] + (50 * arcSharpnessJASON)) + "," + (midXY[1] - (75 * arcSharpnessJASON)) + "," + destXY[0] + "," + destXY[1];
            if (datum.type == "half") {
                return "M" + originXY[0] + ',' + originXY[1] + "T" + midXY[0] + "," + midXY[1];
            }
            else {
                return "M" + originXY[0] + ',' + originXY[1] + "S" + (midXY[0] + (50 * arcSharpnessJASON)) + "," + (midXY[1] - (75 * arcSharpnessJASON)) + "," + destXY[0] + "," + destXY[1];
            }
            //return "M" + originXY[0] + ',' + originXY[1] + "S" + (midXY[0] + (50 * arcSharpnessJASON)) + "," + (midXY[1] - (75 * arcSharpnessJASON)) + "," + destXY[0] + "," + destXY[1];
            //
  ...
  function handleBubbles (layer, data, options ) {
    ...
    bubbles
      ...
      .style('fill', function ( datum ) {
          return typeof datum.fillColor !== 'undefined' ? datum.fillColor : options.fillColor;
